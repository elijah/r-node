...
rnode.graphs.Histogram.prototype.plot = function (target, d) { 
    ...
    var yscale = pv.Scale.linear (0, pv.max (d.data.counts)).range (0, elHeight - 80).nice();
    var xscale = pv.Scale.linear (0, d.data.counts.length).range (0, elWidth - 80);
    ...
    vis.add (pv.Rule)
        .data (yticks)
        .left (-10)
        .width(function (d) { return this.index != 0 ? 10 : 10 + elWidth - 80; })
